...
<div class="flex gap-2">
    ...
    <Dialog.Root bind:open={openApprove}>
        ...
        <Dialog.Content class="sm:max-w-[400px]">
            <Dialog.Header>
                <Dialog.Title>Setujui Pengajuan Cuti</Dialog.Title>
                <Dialog.Description>
                    Anda akan menyetujui pengajuan cuti dari <strong
    ...
    <Dialog.Root bind:open={openReject}>
        ...
        <Dialog.Content class="sm:max-w-[400px]">
            <Dialog.Header>
                <Dialog.Title>Tolak Pengajuan Cuti</Dialog.Title>
                <Dialog.Description>
                    Anda akan menolak pengajuan cuti dari <strong
                        >{request.employeeName}</strong
                    >.
                </Dialog.Description>
            </Dialog.Header>
